...
#define __ARMv81MML_CMSIS_VERSION                                                                                                          \
    ((__ARMv81MML_CMSIS_VERSION_MAIN << 16U) | __ARMv81MML_CMSIS_VERSION_SUB) /*!< \deprecated CMSIS HAL                                   \
                                                                                 version number */
...
__STATIC_INLINE void __NVIC_SetPriorityGrouping(uint32_t PriorityGroup)
{
    ...
    reg_value =
        (reg_value | ((uint32_t)0x5FAUL << SCB_AIRCR_VECTKEY_Pos) | (PriorityGroupTmp << 8U)); /* Insert write key and priorty group */
    SCB->AIRCR = reg_value;
}
