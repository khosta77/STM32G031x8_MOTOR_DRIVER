...
/* Uncomment the line below according to the target STM32G0 device used in
   your application
  */

#if !defined(STM32G071xx) && !defined(STM32G081xx) && !defined(STM32G070xx) && !defined(STM32G030xx) && !defined(STM32G031xx)              \
...
#define __STM32G0_CMSIS_VERSION                                                                                                            \
    ((__STM32G0_CMSIS_VERSION_MAIN << 24) | (__STM32G0_CMSIS_VERSION_SUB1 << 16) | (__STM32G0_CMSIS_VERSION_SUB2 << 8)                     \
