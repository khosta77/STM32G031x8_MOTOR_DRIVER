...
typedef struct
{
    ...
    __IO uint32_t IT_LINE_SR[32]; /*!< SYSCFG configuration IT_LINE register, Address
                                     offset: 0x80 */
} SYSCFG_TypeDef;
...
#define EXTI_IMR1_IM_Msk                                                                                                                   \
    (0xF2A9FFFFUL << EXTI_IMR1_IM_Pos) /*!< 0xF2A9FFFF                                                                                     \
                                        */
...
#define IS_DMAMUX_REQUEST_GEN_ALL_INSTANCE(INSTANCE)                                                                                       \
    (((INSTANCE) == DMAMUX1_RequestGenerator0) || ((INSTANCE) == DMAMUX1_RequestGenerator1) || ((INSTANCE) == DMAMUX1_RequestGenerator2)   \
     || ((INSTANCE) == DMAMUX1_RequestGenerator3))

/******************************* GPIO Instances *******************************/
#define IS_GPIO_ALL_INSTANCE(INSTANCE)                                                                                                     \
    (((INSTANCE) == GPIOA) || ((INSTANCE) == GPIOB) || ((INSTANCE) == GPIOC) || ((INSTANCE) == GPIOD) || ((INSTANCE) == GPIOF))
/******************************* GPIO AF Instances ****************************/
...
#define IS_TIM_INSTANCE(INSTANCE)                                                                                                          \
    (((INSTANCE) == TIM1) || ((INSTANCE) == TIM2) || ((INSTANCE) == TIM3) || ((INSTANCE) == TIM14) || ((INSTANCE) == TIM16)                \
     || ((INSTANCE) == TIM17))
...
#define IS_TIM_DMA_INSTANCE(INSTANCE)                                                                                                      \
    (((INSTANCE) == TIM1) || ((INSTANCE) == TIM2) || ((INSTANCE) == TIM3) || ((INSTANCE) == TIM16) || ((INSTANCE) == TIM17))
...
#define IS_TIM_CCX_INSTANCE(INSTANCE, CHANNEL)                                                                                             \
    ((((INSTANCE) == TIM1)                                                                                                                 \
     ...
     || (((INSTANCE) == TIM3)                                                                                                              \
         && (((CHANNEL) == TIM_CHANNEL_1) || ((CHANNEL) == TIM_CHANNEL_2) || ((CHANNEL) == TIM_CHANNEL_3)                                  \
             || ((CHANNEL) == TIM_CHANNEL_4)))                                                                                             \
     || (((INSTANCE) == TIM14) && (((CHANNEL) == TIM_CHANNEL_1))) || (((INSTANCE) == TIM16) && (((CHANNEL) == TIM_CHANNEL_1)))             \
